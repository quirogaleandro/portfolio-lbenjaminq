...
export const projects = [
  {
    name:"Countries app",
    overview:"Single Page Aplication (SPA) para usuarios donde pueden buscar y/o crear actividades en cada país del mundo, filtrar y ordernar los mismos por distintos parámetros.",
  ...
  },
  {
    ...
    overview:" Foro Online B2B (Bussines to Bussines) para importadores/exportadores de Commodities a nivel internacional. Los usuarios generan “posteos” donde puedan ofrecer/buscar productos.",
  ...
  {
    name:"Netflix Clone",
    overview:"Clon de Netflix hecho en React, implementando Firebase para el manejo de usuarios y Material UI para los estilos",
